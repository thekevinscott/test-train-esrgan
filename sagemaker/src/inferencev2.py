...
class TrainedJob:
    ...
    def __str__(self):
        try:
            ...
            return f'{self.root_folder}: {config}'
    ...
    def _parse_path(self, pathname):
        return self.root_folder / pathname
...
def load_trained_jobs(ROOT_VOLUME):
    return [TrainedJob(ROOT_VOLUME / architecture_type) for architecture_type in os.listdir(ROOT_VOLUME)]
