...
class WeightPruner:
    """Class object to setup and carry the weight pruning.
    ...
    def __init__(
        ...
        assert generator.patch_size != None
    ...
    def train(self, epochs, steps_per_epoch, batch_size, monitored_metrics,compression_quality=None,sharpen_amount=None,vary_compression_quality=False):
        ...
        self.model_for_pruning.compile(optimizer='adam',
        ...
        for epoch in range(starting_epoch, epochs):
            ...
            for step in tqdm(range(steps_per_epoch)):
                ...
                model_losses = self.model_for_pruning.train_on_batch(batch['lr'], y_train)

                # model_for_pruning.fit(batch['lr'], y_train,
